...
public class CreateClientController implements Initializable {
    ...
    private void createClient() {
        ...
        error_lbl.setText("-fx-text-fill: blue; -fx-font-size: 2.3em; -fx-font-weight: bold;");
    ...
    private void createAccount(String accountType) {
       ...
       if(accountType.equals("Checking")){
           ...
           Model.getInstance().getDatabaseDriver().createSavingsAccount(payeeAddress,accountNumber, 20000, balance );
       }
    }
